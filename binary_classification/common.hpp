...
/* ---------- 全局常量 ---------- */
constexpr int    NUM_FEATS   = 32;      // feature dim
constexpr int TOP32_IDX[NUM_FEATS] = {
     2, 96,  3, 23, 22,  5, 79, 122,
   124,123, 29, 50, 32,  0, 30, 31,
    92, 34, 16, 18,  1,  9, 27, 26,
    94, 95, 15, 91, 28, 33, 54,  8
};
