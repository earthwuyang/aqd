...
constexpr int NUM_FEATS  = 32;         // <- new length exposed outside

/* 32 indices (0-based) that map ORIG_FEATS → the SHAP Top-32          */
/*            ↓  feature name                                           */
static constexpr int KEEP_IDX[NUM_FEATS] = {
  57,  // avg_prefix_cost_norm
   0,  // avg_rows_examined_logtanh
   3,  // avg_read_cost_logtanh
  22,  // max_read_eval_ratio
   2,  // avg_filtered_pct_logtanh
  14,  // selectivity_min
   5,  // avg_prefix_cost_logtanh
   1,  // avg_rows_produced_logtanh
   4,  // avg_eval_cost_logtanh
  23,  // log_query_cost
  35,  // min_read_cost_logtanh
  60,  // max_read_eval_ratio_dup
   6,  // avg_data_read_logtanh
  25,  // avg_prefix_read_ratio
  27,  // avg_eval_rows_ratio
  96,  // depth3_prefix_ratio
  26,  // avg_read_rows_ratio
 110,  // biggest_ratio_log
  11,  // ratio_access_full
  63,  // outer_rows_logtanh
  21,  // avg_read_eval_ratio
  34,  // max_prefix_cost_logtanh
  30,  // depth_index_use_signal
  62,  // sel_max_over_sel_min
   8,  // ratio_access_ref
  44,  // filtered_vs_selectivity
 116,  // sel_avg_1_10pct
  13,  // selectivity_mean
  16,  // plan_max_depth
   7,  // ratio_access_range
  20,  // uses_temp_table
  12   // ratio_using_index_hint
};
