...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default = 'tpcds_sf1')
    parser.add_argument("--target_path", type=str, default= '/home/wuy/DB/pg_mem_data/workloads/tpcds_sf1/TP_queries.sql')
