...
def main():
    ...
    argparser.add_argument('--dataset', type=str, default='airline', help='dataset name')
    argparser.add_argument('--data_dir', type=str, default='/home/wuy/query_costs_TP_heavy/', help='data directory')
    argparser.add_argument('--db', type=str, default='airline', help='database name')
