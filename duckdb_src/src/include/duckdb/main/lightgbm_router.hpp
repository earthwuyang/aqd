...
//! Standalone LightGBM query router
...
public:
    ...
    //! ML-based routing using only features
    RoutingDecision PredictRoutingFromFeatures(const QueryFeatures &features);
    
    //! Get routing statistics
    string GetRoutingStats() const;
    
    //! Check if ML routing is available
    bool IsMLRoutingEnabled() const;
