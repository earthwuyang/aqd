...
#define CONFIGURE_ARGS " '--prefix=/home/wuy/DB/pg_duckdb_postgres/postgresql_local' '--with-openssl' '--without-icu' '--enable-debug' '--enable-cassert'"
...
#define PG_VERSION_STR "PostgreSQL 16.4 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.2.0-7ubuntu2) 11.2.0, 64-bit"
